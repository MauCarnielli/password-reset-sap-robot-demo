<?php
	...
	if($method == 'POST'){ 
		...
		if($id != NULL){
			...
			$orchestratorData = json_encode( // Este щ o conteњdo do JSON da nova requisiчуo que vai ser mandada para o Orchestrator para iniciar o Job
				'startInfo' => array(
					"ReleaseKey": "Insira a chave aqui",
					"Strategy": "All",
					"RobotIds": [],
					"NoOfRobots": 0 // Referъncia: https://orchestrator.uipath.com/v2018.2/reference#section-starting-a-job
				)
			); 
